package com.adam.darklightwallpaper.ui.adapter;
...
import com.adam.darklightwallpaper.ui.dialog.WallpaperActionsDialog;
import com.adam.darklightwallpaper.utils.DeviceUtil;
import com.adam.darklightwallpaper.utils.WallpaperUtil;
import com.adam.darklightwallpaper.utils.WallpaperUtil.WallpaperType;
...
public class ViewPagerAdapter extends RecyclerView.Adapter<ViewPagerAdapter.ViewHolder> {
    ...
    public String getTitle(int position) {
        int[] stringRes = {R.string.wallpaper_tab_light, R.string.wallpaper_tab_dark};
